...
// NOTE: We intentionally do not import `electron.vite.config.ts` here.
// That config pulls in the Electron/Vite toolchain which can introduce ESM/CJS interop issues
